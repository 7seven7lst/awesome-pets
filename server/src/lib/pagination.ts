/** Page size for `GET /api/v1/pets` list (matches fullstack `PETS_PAGE_SIZE`). */
export const PETS_PAGE_SIZE = 10;

/** Page size for medical history on pet detail. */
...
export function parsePageSizeParam(raw: string | undefined, defaultSize: number, maxSize = MAX_PAGE_SIZE): number {
